...
void protobuf_AddDesc_hello_5fworld_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

#else
void protobuf_AddDesc_hello_5fworld_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_hello_5fworld_2eproto_once_);
void protobuf_AddDesc_hello_5fworld_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_hello_5fworld_2eproto_once_,
                 &protobuf_AddDesc_hello_5fworld_2eproto_impl);
}
#else
...
DlcInfo::DlcInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:chromeos_hello_world.DlcInfo)
}
...
DlcInfo::DlcInfo(const DlcInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chromeos_hello_world.DlcInfo)
}
...
DlcInfo::~DlcInfo() {
  // @@protoc_insertion_point(destructor:chromeos_hello_world.DlcInfo)
  SharedDtor();
}
...
void DlcInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:chromeos_hello_world.DlcInfo)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:chromeos_hello_world.DlcInfo)
  for (;;) {
      ...
      case 1: {
        if (tag == 10) {
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "chromeos_hello_world.DlcInfo.dlc_id"));
        } else {
          goto handle_unusual;
        }
...
success:
  // @@protoc_insertion_point(parse_success:chromeos_hello_world.DlcInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chromeos_hello_world.DlcInfo)
  return false;
#undef DO_
}
...
void DlcInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:chromeos_hello_world.DlcInfo)
  // optional string dlc_id = 1;
  ...
  // @@protoc_insertion_point(serialize_end:chromeos_hello_world.DlcInfo)
}

int DlcInfo::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:chromeos_hello_world.DlcInfo)
  int total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:chromeos_hello_world.DlcInfo)
...
// @@protoc_insertion_point(class_specific_copy_from_start:chromeos_hello_world.DlcInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string DlcInfo::GetTypeName() const {
  return "chromeos_hello_world.DlcInfo";
}
...
void DlcInfo::clear_dlc_id() {
 ...
 const ::std::string& DlcInfo::dlc_id() const {
  // @@protoc_insertion_point(field_get:chromeos_hello_world.DlcInfo.dlc_id)
 ...
 void DlcInfo::set_dlc_id(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:chromeos_hello_world.DlcInfo.dlc_id)
}
 void DlcInfo::set_dlc_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:chromeos_hello_world.DlcInfo.dlc_id)
}
 void DlcInfo::set_dlc_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:chromeos_hello_world.DlcInfo.dlc_id)
}
 ::std::string* DlcInfo::mutable_dlc_id() {
  
  // @@protoc_insertion_point(field_mutable:chromeos_hello_world.DlcInfo.dlc_id)
  return dlc_id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* DlcInfo::release_dlc_id() {
  // @@protoc_insertion_point(field_release:chromeos_hello_world.DlcInfo.dlc_id)
 ...
 void DlcInfo::set_allocated_dlc_id(::std::string* dlc_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:chromeos_hello_world.DlcInfo.dlc_id)
}
...
DlcParameters::DlcParameters()
  : ::google::protobuf::MessageLite(), _arena_ptr_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:chromeos_hello_world.DlcParameters)
}
...
DlcParameters::DlcParameters(const DlcParameters& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:chromeos_hello_world.DlcParameters)
}
...
DlcParameters::~DlcParameters() {
  // @@protoc_insertion_point(destructor:chromeos_hello_world.DlcParameters)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:chromeos_hello_world.DlcParameters)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:chromeos_hello_world.DlcParameters)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated .chromeos_hello_world.DlcInfo dlc_infos = 1;
      case 1: {
        if (tag == 10) {
        ...
        if (tag == 18) {
         parse_omaha_url:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "chromeos_hello_world.DlcParameters.omaha_url"));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectAtEnd()) goto success;
...
success:
  // @@protoc_insertion_point(parse_success:chromeos_hello_world.DlcParameters)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:chromeos_hello_world.DlcParameters)
  return false;
#undef DO_
}
...
void DlcParameters::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:chromeos_hello_world.DlcParameters)
  // repeated .chromeos_hello_world.DlcInfo dlc_infos = 1;
  ...
  // @@protoc_insertion_point(serialize_end:chromeos_hello_world.DlcParameters)
}

int DlcParameters::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:chromeos_hello_world.DlcParameters)
  int total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:chromeos_hello_world.DlcParameters)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:chromeos_hello_world.DlcParameters)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string DlcParameters::GetTypeName() const {
  return "chromeos_hello_world.DlcParameters";
}
...
const ::chromeos_hello_world::DlcInfo& DlcParameters::dlc_infos(int index) const {
  // @@protoc_insertion_point(field_get:chromeos_hello_world.DlcParameters.dlc_infos)
  return dlc_infos_.Get(index);
}
::chromeos_hello_world::DlcInfo* DlcParameters::mutable_dlc_infos(int index) {
  // @@protoc_insertion_point(field_mutable:chromeos_hello_world.DlcParameters.dlc_infos)
  return dlc_infos_.Mutable(index);
}
::chromeos_hello_world::DlcInfo* DlcParameters::add_dlc_infos() {
  // @@protoc_insertion_point(field_add:chromeos_hello_world.DlcParameters.dlc_infos)
  return dlc_infos_.Add();
}
::google::protobuf::RepeatedPtrField< ::chromeos_hello_world::DlcInfo >*
DlcParameters::mutable_dlc_infos() {
  // @@protoc_insertion_point(field_mutable_list:chromeos_hello_world.DlcParameters.dlc_infos)
  return &dlc_infos_;
}
const ::google::protobuf::RepeatedPtrField< ::chromeos_hello_world::DlcInfo >&
DlcParameters::dlc_infos() const {
  // @@protoc_insertion_point(field_list:chromeos_hello_world.DlcParameters.dlc_infos)
  return dlc_infos_;
}
...
void DlcParameters::clear_omaha_url() {
 ...
 const ::std::string& DlcParameters::omaha_url() const {
  // @@protoc_insertion_point(field_get:chromeos_hello_world.DlcParameters.omaha_url)
 ...
 void DlcParameters::set_omaha_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:chromeos_hello_world.DlcParameters.omaha_url)
}
 void DlcParameters::set_omaha_url(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:chromeos_hello_world.DlcParameters.omaha_url)
}
 void DlcParameters::set_omaha_url(const char* value, size_t size) {
  ...
  omaha_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:chromeos_hello_world.DlcParameters.omaha_url)
}
 ::std::string* DlcParameters::mutable_omaha_url() {
  
  // @@protoc_insertion_point(field_mutable:chromeos_hello_world.DlcParameters.omaha_url)
 ...
 ::std::string* DlcParameters::release_omaha_url() {
  // @@protoc_insertion_point(field_release:chromeos_hello_world.DlcParameters.omaha_url)
 ...
 void DlcParameters::set_allocated_omaha_url(::std::string* omaha_url) {
  ...
  // @@protoc_insertion_point(field_set_allocated:chromeos_hello_world.DlcParameters.omaha_url)
}
