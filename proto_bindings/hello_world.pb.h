...
class DlcInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_hello_world.DlcInfo) */ {
 public:
  DlcInfo();
  virtual ~DlcInfo();
  ...
  // @@protoc_insertion_point(class_scope:chromeos_hello_world.DlcInfo)
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_hello_5fworld_2eproto_impl();
  #else
...
class DlcParameters : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_hello_world.DlcParameters) */ {
 public:
  DlcParameters();
  ...
  const ::chromeos_hello_world::DlcInfo& dlc_infos(int index) const;
  ::chromeos_hello_world::DlcInfo* mutable_dlc_infos(int index);
  ::chromeos_hello_world::DlcInfo* add_dlc_infos();
  ...
  // @@protoc_insertion_point(class_scope:chromeos_hello_world.DlcParameters)
 private:
  ...
  bool _is_default_instance_;
  ::google::protobuf::RepeatedPtrField< ::chromeos_hello_world::DlcInfo > dlc_infos_;
